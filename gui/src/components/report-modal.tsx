    ...
    >
      ...
      >
        <div className="flex items-center justify-between border-b border-prism-border px-5 py-3.5">
          <div className="font-display text-base font-semibold text-prism-text">Report Preview</div>
          <div className="flex gap-2">
            ...
            <button
              onClick={onClose}
              className="flex items-center gap-1.5 rounded-lg border border-prism-muted-2/40 px-3.5 py-1.5 text-xs font-semibold text-prism-muted transition-colors hover:bg-prism-card"
            >
        ...
        <iframe ref={iframeRef} srcDoc={html} title="report-preview" className="min-h-[60vh] flex-1 border-none" />
      </div>
    </div>
  );
}
