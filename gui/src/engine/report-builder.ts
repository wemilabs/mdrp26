...
function reportShell(
  ...
  <style>
    ...
    <div class="disclaimer">
      <strong>About this report:</strong> Generated by PRISM, an explainable risk assessment tool. A lightweight, real-time approximation method estimates contributing factors. PRISM is a research and demonstration tool and is NOT YET validated for clinical use or real patient decision-making.
    </div>
  </body></html>`;
}
...
export function buildPatientReportHTML(
  ...
  const recItems = recs.items
    .map((it) => `<li>${escapeHtml(it.advice)}</li>`)
    .join("");
