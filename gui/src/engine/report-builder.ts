...
function reportShell(kicker: string, title: string, meta: string, bodyHtml: string): string {
  ...
  <style>
    ...
    <div class="disclaimer">
      <strong>About this report:</strong> Generated by PRISM, a browser-based explainable risk assessment tool. Contributing factors are estimated using a lightweight, real-time approximation method. PRISM is a research and demonstration tool and is not validated for clinical use or real patient decision-making.
    </div>
  </body></html>`;
}
...
export function buildPatientReportHTML(
  ...
  return reportShell("CLINICAL DECISION SUPPORT", "PRISM Risk Report", `Generated ${escapeHtml(timestamp)}`, body);
}
...
export function buildDashboardReportHTML(): string {
  ...
  return reportShell("CLINICAL DECISION SUPPORT", "PRISM Performance Summary", `Generated ${escapeHtml(timestamp)}`, body);
}
